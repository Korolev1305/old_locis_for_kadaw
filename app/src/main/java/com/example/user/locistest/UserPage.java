...
import com.example.user.locistest.Api.SearchSongsTask;
    ...
    private void bindViews(){
        ...
        createRoomButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final SearchSongsTask api = new SearchSongsTask(token,"never gonna");
                api.execute(getWindow().getContext());
    ...
    private void initListView(List<RoomInList> rooms){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                RoomInList selectedRoom = roomsList.get(position);
